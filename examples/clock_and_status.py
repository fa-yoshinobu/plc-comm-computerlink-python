...
STATUS_FIELDS = [
    ...
    ("Write-protected program and supplementary information", "write_protected_program_info"),
    ...
    ("Write-priority limited program and supplementary information", "write_priority_limited_program_info"),
...
def main() -> int:
    # Read CPU clock and decode all CPU status flags.
    p = argparse.ArgumentParser(description="Clock and CPU status example")
