...
Report vulnerabilities privately via [GitHub Security Advisories](https://github.com/fa-yoshinobu/plc-comm-computerlink-python/security/advisories/new) or by contacting the maintainer directly.
