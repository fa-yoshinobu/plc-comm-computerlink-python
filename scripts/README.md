...
- `scripts/run_validation_all.bat`
...
- `scripts/run_device_read_scan.bat`
...
scripts\\run_device_range_scan.bat 192.168.250.100 1027 udp 12000 5 2 0x200 16 device_range.log
...
python scripts\\final_whl_edge_test.py --host 192.168.250.100 --port 1027 --protocol udp --local-port 12000 --program-prefix P1 --write-mode bits --timeout 5 --retries 1 --log final_whl_edge_udp_bits.log
scripts\\run_final_whl_edge_matrix.bat 192.168.250.100 1025 1027 12000 5 1 final_whl_edge_matrix_logs
